...
Lets parents log one or more named solid-food exposures in a single submit, with optional per-food preference and a shared meal comment, without mixing them into bottle feeding volume.
